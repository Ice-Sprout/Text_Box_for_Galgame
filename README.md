...
- 1.5 添加了gui功能，对预生成进行了优化，能够处理不同尺寸背景并赋予透明框方便查看白色文本。修正了requirements和env.bat，对不必要的文件进行了删减。（2025.11.30 by Ice-Sprout）
